  ...
  const details = (
    <>
      ...
      <div className="min-w-0">
        ...
        <p className="mt-0.5 break-all text-sm font-black text-foreground">{body}</p>
      </div>
    </>
  );

  return (
    <div className="flex min-w-0 items-start gap-2 rounded-xl border border-pink-100 bg-pink-50/40 p-3 transition-colors hover:bg-pink-50">
      {href ? (
